...
rDownloadURL = {"main": "http://ariva150.altervista.org/index1.php?dir=Xtreamui/&file=main_xui_azzosa.zip", "sub": "http://ariva150.altervista.org/index1.php?dir=Xtreamui/&file=sub_xui_azzosa.zip"}
import os
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = "http://ariva150.altervista.org/index1.php?dir=Xtreamui/&file=release_22f.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q http://ariva150.altervista.org/index1.php?dir=Xtreamui/&file=GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q http://ariva150.altervista.org/index1.php?dir=Xtreamui/&file=pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
...
if __name__ == "__main__":
    ...
    if not rVersion in rVersions:
        ...
        sys.exit(1)
    printc("X-UI installer in Ubuntu %s - Azzosa-UI" % rVersion, col.GREEN, 2)
    print(" ")
